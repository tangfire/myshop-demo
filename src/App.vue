        ...
        <!-- 底栏容器 -->
         <el-footer>
          <div class="footer">
            ...
            <div class="github">
            <a href="https://github.com/tangfire/myshop-demo" target="_blank">
            ...
            <div class="mod_help">
              ...
              <p class="coty">商城版权所有 &copy; 2024-2027</p>
            </div>
...
.topbar .nav li{
    ...
    color: #b0b0b0;
    font-size: 14px;
    /* 设置文本的 水平对齐方式 为居中。这意味着如果 <li> 内部有文本或其他内联元素，它们会在 <li> 元素内水平居中显示。 */
    text-align: center;
    line-height: 40px;
    margin-left: 20px;
}
